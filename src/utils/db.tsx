    ...
    data: [
      {
        ...
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/t-shirt/m/9/u/l-tsrt-catalog-14-kajaru-original-imah4qtagcpkxxzs.jpeg?q=60&crop=false',
        title: 'T-shirts',
      ...
      },
      {
        ...
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/jean/q/z/g/32-t-baggy-light-blue-tidda-original-imah3ztwwzsvtfax.jpeg?q=60&crop=false',
        title: 'Jeans',
      ...
      },
      {
        ...
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/jacket/i/l/p/xl-1-no-heavy-upar-0-futse-peno-original-imah6hzhet6zpyaa.jpeg?q=60&crop=false',
        title: 'Jackets',
      ...
      },
      {
        ...
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/kurta/x/f/y/l-kurta1513-bellstone-original-imah7nywnygwdqhv.jpeg?q=60&crop=false',
        title: 'Kurtas',
        subTitle: 'Upto 50% off',
      },
    ],
    ...
    data: [
      {
        ...
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/shirt/k/2/n/xxl-box01-jackbella-original-imah4hhhse4gzghk.jpeg?q=60&crop=false',
      },
      {
        id: 3,
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/shirt/e/i/h/xxl-men-regular-slim-fit-solid-button-down-collar-formal-shirt-original-imaggvvnywmgthyq.jpeg?q=60&crop=false',
      },
      {
        id: 4,
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/shirt/w/0/a/s-0721-sh95-08-the-indian-garage-co-original-imagmhjgdyr4zeaq.jpeg?q=60&crop=false',
      },
      {
        id: 5,
        path: '',
        image_uri:
          'https://rukminim2.flixcart.com/image/536/644/xif0q/trouser/r/k/5/30-phtr000026-highlander-original-imagua3nckfuzzgw.jpeg?q=60&crop=false',
      },
    ],
  },
  {
    ...
    data: [
      {
        ...
        path: '',
        image_uri:
          'https://m.media-amazon.com/images/I/71tGtBuo0yL._AC_UY436_FMwebp_QL65_.jpg',
      ...
      },
      {
        ...
        path: '',
        image_uri:
          'https://m.media-amazon.com/images/I/81CwAlYjJ4L.__AC_SX300_SY300_QL70_FMwebp_.jpg',
        title: 'Sofa',
        subTitle: 'Wildest Range',
      },
      {
        id: 4,
        path: '',
        image_uri:
          'https://m.media-amazon.com/images/I/71EWAUphg2L._AC_UY436_FMwebp_QL65_.jpg',
        title: 'Laptop',
      ...
      },
      {
        ...
        path: '',
        image_uri:
          'https://media.istockphoto.com/id/1408099652/photo/xbox.jpg?s=612x612&w=0&k=20&c=U35tDYndjlTUebitLvkqE1_xbzCihjRhlGaE9mmD7ck=',
...
export const productData = [
  {
    id: 1,
    image_uri:
      'https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/t/g/v/l-126703706-jack-jones-original-imagt4rhgg6ehhct.jpeg?q=70',
    name: 'Google Pixel 4',
